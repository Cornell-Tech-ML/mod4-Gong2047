    ...
    * Fill in the `out` array by applying `fn` to each
    ...
    def _map(
        ...
        for ordinal in range(size):
            ...
            # Compute in_index from out_index using broadcast rules
...
def tensor_zip(
    ...
    * Fill in the `out` array by applying `fn` to each
    ...
    def _zip(
        ...
        for ordinal in range(size):
            to_index(ordinal, out_shape, out_index)
            # Compute a_index and b_index from out_index using broadcast rules
    ...
    * `out_shape` will be the same as `a_shape`
    ...
    def _reduce(
        ...
        for ordinal in range(size):
            ...
            # Initialize accumulator with the start value already in out[out_pos]
